...
import type { InventoryHeatmapLocationDetail, InventoryHeatmapSkuDetail, SiteInventorySummary, WarehouseAddress, WarehouseRegion } from '../types'
...
export default function InventoryHeatmapPage({ siteInventory, stateInventory, addresses, details, locationDetails = [], loading, onLoad }: { siteInventory: SiteInventorySummary[]; stateInventory: Record<string, number>; addresses: WarehouseAddress[]; details: InventoryHeatmapSkuDetail[]; locationDetails?: InventoryHeatmapLocationDetail[]; loading: boolean; onLoad: () => Promise<void> }) {
  ...
  return <div className="page">
    ...
    <HeatmapSkuDetailTable mode="inventory" rows={filteredDetails}/>
  </div>
}
