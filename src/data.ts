...
export const fileSlots: FileSlotDefinition[] = [
  ...
  { id: 'amazonOutbound', label: '亚马逊仓配出库数据', group: '事实表', requiredFields: [], optionalFields: ['日期', 'SKU', '邮编', '数量', '仓库名称', '履约方式'] },
  { id: 'merchantOutbound', label: '商家自发货出库数据', group: '事实表', requiredFields: [], optionalFields: ['日期', 'SKU', '邮编', '数量', '仓库名称', '国家/地区'] },
  ...
  { id: 'warehouseMaterial', label: '仓库与物料对照表', group: '维度表', requiredFields: [], optionalFields: ['事业部', '仓库名称', '物料编码'] },
]
