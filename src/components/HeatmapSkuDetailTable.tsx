...
export default function HeatmapSkuDetailTable(props: HeatmapSkuDetailTableProps) {
  ...
  return <section className="section sku-detail-section">
    ...
    <div className="table-frame sku-detail-scroll">
      <table>
        <thead><tr><th>区域</th><th>销售产品线</th><th>销售系列</th><th>型号</th><th>商品编码</th>{props.mode === 'sales' ? <><th>亚马逊仓配发货量</th><th>商家自发货发货量</th><th>合计发货量</th><th>占比</th></> : <><th>在库量（件）</th><th>在途量（件）</th><th>合计（件）</th><th>占比</th></>}</tr></thead>
